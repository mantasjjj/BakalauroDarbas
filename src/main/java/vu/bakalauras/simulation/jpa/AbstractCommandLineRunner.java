...
public class AbstractCommandLineRunner implements CommandLineRunner {
    ...
    public List<Customer> fillCustomers() {
        ...
        customers.add(new Customer(Arrays.asList(new CustomerCriteria(Category.SEARCH_RESULT_ACCURACY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRODUCT_QUALITY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.SELLER_QUALITY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PHOTOS, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRICE, CriteriaImportance.OPTIONAL))));

        customers.add(new Customer(Arrays.asList(new CustomerCriteria(Category.SEARCH_RESULT_ACCURACY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRODUCT_QUALITY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRICE, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PHOTOS, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.SELLER_QUALITY, CriteriaImportance.OPTIONAL))));

        customers.add(new Customer(Arrays.asList(new CustomerCriteria(Category.SEARCH_RESULT_ACCURACY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.SELLER_QUALITY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRICE, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PHOTOS, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRODUCT_QUALITY, CriteriaImportance.OPTIONAL))));

        customers.add(new Customer(Arrays.asList(new CustomerCriteria(Category.SEARCH_RESULT_ACCURACY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PRODUCT_QUALITY, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.DESCRIPTION, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.PHOTOS, CriteriaImportance.MANDATORY),
                new CustomerCriteria(Category.SELLER_QUALITY, CriteriaImportance.MANDATORY))));
    ...
    private List<ShopCriteria> fillAmazonShopCriteria() {
        ...
        amazonCriteria.add(new ShopCriteria("Geras peržiūros / pardavimo santykis",
                Arrays.asList(Category.SELLER_QUALITY, Category.PRODUCT_QUALITY), CriteriaWeight.HIGH));
        amazonCriteria.add(new ShopCriteria("Produkto aprašymo kokybė",
                Arrays.asList(Category.SELLER_QUALITY, Category.PRODUCT_QUALITY, Category.DESCRIPTION, Category.SEARCH_RESULT_ACCURACY), CriteriaWeight.HIGH));
        ...
        amazonCriteria.add(new ShopCriteria("Produkto pavadinime esantys nereikalingi žodžiai",
                Arrays.asList(Category.SEARCH_RESULT_ACCURACY, Category.SELLER_QUALITY), CriteriaWeight.MEDIUM));
        ...
        amazonCriteria.add(new ShopCriteria("Gera turinio kokybė",
                Arrays.asList(Category.SELLER_QUALITY, Category.PRODUCT_QUALITY, Category.DESCRIPTION), CriteriaWeight.MEDIUM));
        ...
        amazonCriteria.add(new ShopCriteria("Produkto aprašymo raktažodžiai",
                Arrays.asList(Category.SEARCH_RESULT_ACCURACY), CriteriaWeight.LOW));
    ...
    private List<ShopCriteria> fillAliExpressShopCriteria() {
        ...
        aliExpressCriteria.add(new ShopCriteria("Užsakymų skaičius",
                Arrays.asList(Category.PRODUCT_QUALITY), CriteriaWeight.HIGH));
        aliExpressCriteria.add(new ShopCriteria("Atsiliepimų skaičius",
                Arrays.asList(Category.SELLER_QUALITY), CriteriaWeight.HIGH));
        ...
        aliExpressCriteria.add(new ShopCriteria("Specifiškai AliExpress atrinkti produktai AliExpress Choice",
                Arrays.asList(Category.PRODUCT_QUALITY, Category.PRICE, Category.DESCRIPTION, Category.SELLER_QUALITY, Category.PHOTOS), CriteriaWeight.HIGH));
        ...
        aliExpressCriteria.add(new ShopCriteria("Produkto turinio kokybė",
                Arrays.asList(Category.SELLER_QUALITY, Category.PRODUCT_QUALITY), CriteriaWeight.MEDIUM));
        ...
        aliExpressCriteria.add(new ShopCriteria("Produkto puslapyje esančios ALT žymos",
                Arrays.asList(Category.SELLER_QUALITY, Category.DESCRIPTION, Category.SEARCH_RESULT_ACCURACY), CriteriaWeight.LOW));
        aliExpressCriteria.add(new ShopCriteria("Produkto ALT žymose esantys raktažodžiai",
                Arrays.asList(Category.SELLER_QUALITY, Category.SEARCH_RESULT_ACCURACY), CriteriaWeight.LOW));
    ...
    private List<ShopCriteria> fillEBayShopCriteria() {
        ...
        ebayriteria.add(new ShopCriteria("Alternatyvios HTML žymos",
                Arrays.asList(Category.SEARCH_RESULT_ACCURACY, Category.SELLER_QUALITY), CriteriaWeight.LOW));
    ...
    private List<ShopCriteria> fillEtsyShopCriteria() {
        ...
        etsyCriteria.add(new ShopCriteria("Produkto paspaudimai",
                Arrays.asList(Category.PHOTOS, Category.SEARCH_RESULT_ACCURACY), CriteriaWeight.MEDIUM));
        etsyCriteria.add(new ShopCriteria("Produkto įsiminimai",
                Arrays.asList(Category.PRODUCT_QUALITY, Category.PHOTOS, Category.SEARCH_RESULT_ACCURACY), CriteriaWeight.MEDIUM));
        ...
        etsyCriteria.add(new ShopCriteria("Specifinės kategorijos",
                Arrays.asList(Category.SEARCH_RESULT_ACCURACY, Category.SELLER_QUALITY, Category.DESCRIPTION), CriteriaWeight.LOW));
